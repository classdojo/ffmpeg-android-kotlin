...
cp -a -p ../../../build/arm64-v8a/bin/ffmpeg ./arm64-v8a/ffmpeg
cp -a -p ../../../build/arm64-v8a/bin/libopenh264.so ./arm64-v8a/libopenh264.so
cp -a -p ../../../build/x86/bin/ffmpeg ./x86/ffmpeg
cp -a -p ../../../build/x86/bin/libopenh264.so ./x86/libopenh264.so
cp -a -p ../../../build/x86_64/bin/ffmpeg ./x86_64/ffmpeg
cp -a -p ../../../build/x86_64/bin/libopenh264.so ./x86_64/libopenh264.so
